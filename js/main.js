...
$(document).on("click", ".poll.unresolved .answer", function(event) {
  ...
  // // this works
  // $.get("http://bw-poll-server.herokuapp.com/api/fashion", function(response) {
